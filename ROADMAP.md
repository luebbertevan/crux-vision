...
stage and transport in document order. Desktop portrait review uses a
responsive 108–132 px left utility rail with a visually separated, top-aligned
brand and utility stack instead of a top bar. The filename moves to a quiet
pill on the stage's top edge, and a 42 px translucent transport overlays the
